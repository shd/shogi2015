...
path3 = "hw-december-17/tsume3/"
path45 = "hw-december-17/tsume45/"
s = []
f = open('names.in')
for x in f:
    a = x.split('\n')
...
#   sg = gen(4,0)
    ...
    r3a = random.randint(1,21)
    r3b = r3a
    while r3b == r3a: r3b = random.randint(1,21)

    r45a = random.randint(1,21)
    r45b = r45a
    while r45b == r45a: r45b = random.randint(1,21)

    s.append((u[2],"\\testwork{"+u[0]+"}{"+u[1]+"}{"+path3+str(r3a)+"}{"+path3+str(r3b)+"}{"+
                                             path45+str(r45a)+"}{"+path45+str(r45b)+"}"))
