...
\hfill\vspace{-6mm}
{\bfseries\large {#1}}
{\begin{center}\Huge 第五宿題\end{center}}
\vspace{-2mm}
{\begin{center}{\large 平成二十七年十一月十二日}\\
\end{center}}
\vspace{-2mm}
...
{\bfseries\large\scshape Домашняя работа №5}\\
{12 ноября 2015 г.}\\
{\itshape\tiny #2}}
\end{center}
...
\begin{tabular}{lp{1.12cm}l}
\begin{minipage}[t]{8.5cm}{\bfseries Задание 1}
...
\begin{minipage}[t]{8.5cm}{\bfseries Задание 2}
...
%\vspace{5mm}
Решите цумэ в 3 хода.

\vspace{0.5cm}
{\itshape Ход чёрных: 

\vspace{0.3cm}
\itshape Наилучший ответ белых:
