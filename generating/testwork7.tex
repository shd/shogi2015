...
\hfill\vspace{-6mm}
{\bf\large {#1}}
{\begin{center}\Huge 第七試験\end{center}}
\vspace{-2mm}
{\begin{center}{\large 平成二十七年十二月十七日}\\
\end{center}}
\vspace{-2mm}
...
{\bfseries\large\scshape Проверочная работа №7}\\
{17 декабря 2015 г.}\\
{\itshape\tiny #2}}
\end{center}
...
\begin{minipage}[t]{8cm}{\bf Цумэ-сёги в 1 ход}
{\small
%\vspace{0.3cm}
%\begin{center}\shodiag{1}{#3}\end{center}
\begin{center}\includegraphics[width=5cm]{#3}\end{center}
{\itshape Ход чёрных: }
\vspace{1cm}
\begin{center}\includegraphics[width=5cm]{#4}\end{center}
{\itshape Ход чёрных: }
\vspace{0.5cm}}
...
\begin{minipage}[t]{8cm}{\bf Цумэ-сёги в 3 хода}
{\small
\begin{center}\includegraphics[width=5.5cm]{#5}\end{center}
{\itshape Ход чёрных/ответ белых/ход чёрных: }
\vspace{1cm}
\begin{center}\includegraphics[width=5.5cm]{#6}\end{center}
{\itshape Ход чёрных/ответ белых/ход чёрных: }
\vspace{1cm}}
